...
- [x] 9.11 Configure commit author attribution independently from the bot's GitHub API identity and Git push credentials, and verify the loader passes the configured human identity to publication
